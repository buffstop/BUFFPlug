...
@interface MFLibrary : NSObject <EDSearchableIndexReasonProvider>
{
...
/* FIXME: CDUnknownBlockType -> id */
- (id)allMailboxesSearchableIndexQueryWithExpression:(id)arg1 builder:(id)arg2 forUnreadCount:(BOOL)arg3 withMailboxExclusions:(BOOL)arg4 includeAttachmentCriterion:(BOOL)arg5;
...
/* FIXME: CDUnknownBlockType -> id */
- (id)_scopeIdentifiersForCriterion:(id)arg1 criterionIdentifierMapper:(id)arg2 allCriteriaAreMailbox:(char *)arg3;
...
/* FIXME: CDUnknownBlockType -> id */
- (void)fileURLForAttachmentID:(id)arg1 messageID:(id)arg2 name:(id)arg3 result:(id)arg4;
...
/* FIXME: CDStruct_33dcf794 -> id */
- (long long)_addMessageToCountContext:(id *)arg1 statement:(id)arg2;
...
/* FIXME: CDStruct_f4b747e6 -> id */
- (id)messageColorForLibraryMessageColor:(char *)arg1;
/* FIXME: CDStruct_f4b747e6 -> id */
- (char *)libraryMessageColorForMessageColor:(id)arg1;
