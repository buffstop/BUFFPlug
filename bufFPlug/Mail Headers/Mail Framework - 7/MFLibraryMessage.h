...
/* FIXME: (Color) CDStruct_f4b747e6 -> id */
- (void)setRemoteID:(const char *)arg1 documentID:(id)arg2 flags:(long long)arg3 size:(unsigned long long)arg4 mailboxID:(long long)arg5 color:(id)arg6 conversationID:(long long)arg7 conversationFlags:(unsigned long long)arg8;
